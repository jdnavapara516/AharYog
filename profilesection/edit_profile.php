...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_POST['gender'], $_POST['dob'], $_POST['age'], $_POST['height'], $_POST['weight'], $_POST['health_condition'])) {
        ...
        // Handle diseases
        $diseases = isset($_POST['diseases']) ? implode(", ", array_map(function($item) use ($conn) { return mysqli_real_escape_string($conn, $item); }, $_POST['diseases'])) : '';
        ...
        // Handle goals
        $goals = isset($_POST['goals']) ? implode(", ", array_map(function($item) use ($conn) { return mysqli_real_escape_string($conn, $item); }, $_POST['goals'])) : '';
